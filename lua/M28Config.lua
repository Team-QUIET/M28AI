...
M28LogWaterZoneDebug = true --If true, logs detailed water zone threat calculations, reinforcement routing, and reinforcement decisions
M28LogAirSystemDebug = true --If true, logs comprehensive air system debug: interceptors, bombers, gunships, transports, scouts, threat calculations, target assignments, and all air decision-making
...
M28LogAirProductionDecisions = true --If true, logs detailed air production decisions: bomber/gunship/transport/scout production triggers, and production focus
