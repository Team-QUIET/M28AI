...
M28DebugOrderFlip = false --Targeted rapid clear/reissue logging; does not enable the full Orders debug channel
...
M28DebugOrderFlipWindow = 2 --Seconds after a previous order where a replacement counts as flip-flop evidence
M28DebugOrderFlipUnitInterval = 1 --Minimum seconds between OrderFlip logs for the same unit
