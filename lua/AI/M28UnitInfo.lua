...
refCategoryMobileSMD = categories.ANTIMISSILE * categories.SILO * categories.TECH3 * categories.MOBILE * categories.LAND
refCategoryAllSMD = refCategorySMD + refCategoryMobileSMD
...
refCategoryBigThreatCategories = refCategoryExperimentalLevel + refCategoryMissileShip + refCategoryAllSMD + refCategoryNavalSurface * categories.BATTLESHIP --Note - this is different to M27 which only considers land experimentals as big threat categories; we also dont include ACU here, but do include in the land exp
