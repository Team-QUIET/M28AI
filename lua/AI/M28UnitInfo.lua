...
refbFlankRaiderAssigned = 'M28FlkRdr' --true if unit is assigned to flank raid (should maintain raid destination, not get dragged to center)
reftFlankRaidTarget = 'M28FlkRdrTgt' --{x,y,z} position of the flank raid target
refiFlankRaidTargetLZ = 'M28FlkRdrLZ' --land zone number of the flank raid target
