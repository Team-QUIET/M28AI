...
-- defaultOrdersTable['M28Toggle'] =
--   {helpText = "M28Toggle",  bitmapId = 'M28charge', preferredSlot = 10, behavior = M28AIToggle,
--    initialStateFunc = M28ScriptButtonInitFunction, extraInfo = 7}
